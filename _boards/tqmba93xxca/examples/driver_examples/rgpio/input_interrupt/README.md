...
```bash
west build mcuxsdk-examples-tq/_boards/tqmba93xxca/examples/driver_examples/rgpio/input_interrupt --board tqmba93xxca -Dcore_id=cm33 -DBINARY_DIR=mcuxsdk-examples-tq/build -DCUSTOM_BOARD_ROOT="mcuxsdk-examples-tq/_boards" --config=debug --pristine
```
