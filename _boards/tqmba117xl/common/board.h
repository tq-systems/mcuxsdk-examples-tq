...
#define BOARD_LED_GPIO BOARD_INITPINS_USER_LED_1_PERIPHERAL
#endif
#ifndef BOARD_LED_GPIO_PIN
#define BOARD_LED_GPIO_PIN BOARD_INITPINS_USER_LED_1_CHANNEL
#endif

#define USER_LED_INIT(output)                                                  \
  GPIO_PinWrite(BOARD_LED_GPIO, BOARD_LED_GPIO_PIN, output);                   \
  BOARD_LED_GPIO->GDIR |=                                                      \
    (1U << BOARD_LED_GPIO_PIN) /*!< Enable target USER_LED */
#define USER_LED_OFF()                                                         \
  GPIO_PortClear(BOARD_LED_GPIO,                                               \
                 1U << BOARD_LED_GPIO_PIN) /*!< Turn off target USER_LED */
#define USER_LED_ON()                                                          \
  GPIO_PortSet(BOARD_LED_GPIO,                                                 \
               1U << BOARD_LED_GPIO_PIN) /*!<Turn on target USER_LED*/
#define USER_LED_TOGGLE()                                                      \
  GPIO_PinWrite(                                                               \
    BOARD_LED_GPIO, BOARD_LED_GPIO_PIN,                                        \
    0x1                                                                        \
      ^ GPIO_PinRead(BOARD_LED_GPIO,                                           \
                     BOARD_LED_GPIO_PIN)) /*!< Toggle target USER_LED */
...
#define BOARD_SMARTCARD_CLOCK_VALUE                                            \
  (4000000U) /*!< SMARTCARD clock frequency                                    \
              */
