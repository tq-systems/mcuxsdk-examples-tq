...
Copy the compiled binary file (ping_pong_buffer_transfer_cm33.bin) to bootable drive of SD card.
Boot the board up and in UBoot run the following command.

```
load mmc 1:1 0x80000000 ping_pong_buffer_transfer_cm33.bin; cp.b 0x80000000 0x201e0000 0x30000; bootaux 0x1ffe0000 0
```
...
## Output on serial terminal of Cortex-M33 as show below for receiver node B
