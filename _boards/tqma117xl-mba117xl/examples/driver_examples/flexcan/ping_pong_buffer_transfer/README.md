...
# FlexCAN Ping Pong Demo

## Overview

The FlexCAN ping pong buffer transfer example shows how to use the FlexCAN queue feature to create
two simulated FIFOs that can receive CAN frames.

In this example, two boards are connected through the CAN bus. Endpoint A (Board A) sends CAN messages to
...
The following message can be seen when the MBa117xL is chosen as Node A (Transmitter).

```
TQ-Systems GmbH
Version:
Branch: tqma117xl-can-bus-ping-pong
...
The following message is seen when board is chosen as Node B (Receiver).
...
Rx MB ID: 0x321, Rx MB data: 0x0, Time stamp: 4353
Rx MB ID: 0x321, Rx MB data: 0x1, Time stamp: 4477
Rx MB ID: 0x321, Rx MB data: 0x2, Time stamp: 4601
Rx MB ID: 0x321, Rx MB data: 0x3, Time stamp: 4726
Read Rx MB from Queue 2.
Rx MB ID: 0x321, Rx MB data: 0x4, Time stamp: 4974
Rx MB ID: 0x321, Rx MB data: 0x5, Time stamp: 5097
Rx MB ID: 0x321, Rx MB data: 0x6, Time stamp: 5221
Rx MB ID: 0x321, Rx MB data: 0x7, Time stamp: 5346
