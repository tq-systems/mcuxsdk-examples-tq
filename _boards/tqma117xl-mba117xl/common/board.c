...
#endif /* __CC_ARM || __ARMCC_VERSION / __MCUXPRESSO / __ICCARM__ || __GNUC__ */
...
void BOARD_ConfigMPU(void)
{
  ...
  if (LMEM_PCCCR_ENCACHE_MASK == (LMEM->PCCCR))
  {
  ...
  if (LMEM_PSCCR_ENCACHE_MASK == (LMEM->PSCCR))
  {
...
#endif /* __CORTEX_M == 7 / __CORTEX_M == 4 */
