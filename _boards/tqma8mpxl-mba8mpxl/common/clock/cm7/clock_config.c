...
void BOARD_BootClockRUN(void)
{
    ...
    CLOCK_SetRootMux(BOARD_DEBUG_UART_CLK_ROOT, kCLOCK_UartRootmuxSysPll1Div10); /* Set UART source to SysPLL1 Div10 80MHZ */
    CLOCK_SetRootDivider(BOARD_DEBUG_UART_CLK_ROOT, 1U, 1U);                     /* Set root clock to 80MHZ/ 1= 80MHZ */
